# MBVD-Fitting
**Introduce**: This is a job I did when I was studying at Tsinghua University, using FBAR resonators impedance data measured by a vector network analyzer（VNA） to estimate MBVD model parameters: R0, C0, R1, L1, C1, Rs. \
